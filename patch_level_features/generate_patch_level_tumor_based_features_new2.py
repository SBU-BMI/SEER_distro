...
if __name__ == '__main__':
  if len(sys.argv)<1:
    print "usage:python generate_patch_level_tumor_based_features_new.py config.json";
    exit();  
  ...
  for item in image_list:  
    ...
    start_i=99;
    start_j=57;    
    for i in range(start_i,patch_x_num):
      for j in  range (start_j,patch_y_num):   
        ...
        if(patchHumanMarkupRelation=="disjoin"):          
            #print case_id,image_width,image_height,user,i,j,patch_min_x_pixel,patch_min_y_pixel,patch_size,patch_polygon_area,"n/a","n/a","n/a","n/a";            
            #saveFeatures2Mongo(case_id,image_width,image_height,user,i,j,patch_min_x_pixel,patch_min_y_pixel,patch_size,patch_polygon_area,"n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a");         
            continue;        
        try:
        ...
        save2Objects(case_id,"tumor",patch_size,patch_polygon1,percent_nuclear_material); 
        #exit();             
    img.close();        
  exit();  
