...
if __name__ == '__main__':
  ...
  #########################################################
  def saveResult2Mongo(case_id,user,patch_width_index,patch_height_index,patch_min_x_pixel,patch_min_y_pixel,patch_size,patch_polygon_area,nucleus_area,percent_nuclear_material,grayscale_patch_mean,grayscale_patch_std,Hematoxylin_patch_mean,Hematoxylin_patch_std,grayscale_segment_mean,grayscale_segment_std,Hematoxylin_segment_mean,Hematoxylin_segment_std):
    ...
    for i in range(0,patch_x_num):
      for j in  range (0,patch_y_num):         
        ...
        if(patchHumanMarkupRelation=="disjoin"):          
            ...
            saveResult2Mongo(case_id,user,i,j,patch_min_x_pixel,patch_min_y_pixel,patch_size,patch_polygon_area,"n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a","n/a");            
            continue;        
        try:
        ...
        saveResult2Mongo(case_id,user,i,j,patch_min_x_pixel,patch_min_y_pixel,patch_size,patch_polygon_area,nucleus_area,percent_nuclear_material,grayscale_patch_mean,grayscale_patch_std,Hematoxylin_patch_mean,Hematoxylin_patch_std,segment_mean_grayscale_intensity,segment_std_grayscale_intensity,segment_mean_hematoxylin_intensity,segment_std_hematoxylin_intensity);        
    img.close();        
  exit();  
