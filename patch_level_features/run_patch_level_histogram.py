...
if __name__ == '__main__':
  if len(sys.argv)<2:
    print "usage:python generate_patch_level_histogram.py case_id user";
    exit();  
  ...
  feature_array=['nucleus_area','percent_nuclear_material']; 
  name_array=['nucleus area (micron square)','nuclear material percentage (%)']; 
