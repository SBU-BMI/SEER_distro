...
if __name__ == '__main__':
  if len(sys.argv)<1:
    print "usage:python generate_patch_level_dataset.py config.json";
    exit();  
    ...
    for i in range(0,patch_x_num):
      for j in  range (0,patch_y_num):         
        ...
        if(patchHumanMarkupRelation=="disjoin"):          
            print case_id,user,i,j,patch_min_x_pixel,patch_min_y_pixel,patch_size,patch_polygon_area,"n/a","n/a","n/a","n/a";
            patch_feature_data = collections.OrderedDict();
            patch_feature_data['case_id'] = case_id;
            patch_feature_data['user'] = user;
            patch_feature_data['patch_width_index'] = i;
            patch_feature_data['patch_height_index'] = j;
            ...
            patch_feature_data['nucleus_area'] = "n/a";
            patch_feature_data['percent_nuclear_material'] = "n/a";
            patch_feature_data['grayscale_patch_mean'] = "n/a";
            patch_feature_data['grayscale_patch_std'] = "n/a";
            patch_feature_data['Hematoxylin_patch_mean'] = "n/a";
            patch_feature_data['Hematoxylin_patch_std'] = "n/a";
            patch_feature_data['grayscale_segment_mean'] = "n/a";
            patch_feature_data['grayscale_segment_std'] = "n/a";
            patch_feature_data['Hematoxylin_segment_mean'] = "n/a";
            patch_feature_data['Hematoxylin_segment_std'] = "n/a";        
            #patch_feature_json = json.dumps(patch_feature_data);
            #print patch_feature_json;
        ...
        if (record_count>0):
          ...
          #print "case_id,comp_execution_id";
          #print case_id,comp_execution_id;
          #print "x1_new,x2_new,y1_new,y2_new,tolerance";
          #print x1_new,x2_new,y1_new,y2_new,tolerance;
          #print "x10,x20,y10,y20";
          #print x10,x20,y10,y20;
          #exit();  
          #print patchHumanMarkupRelation;                                                
        ...
        patch_feature_data['grayscale_segment_mean'] = segment_mean_grayscale_intensity;
        patch_feature_data['grayscale_segment_std'] = segment_std_grayscale_intensity;
        patch_feature_data['Hematoxylin_segment_mean'] = segment_mean_hematoxylin_intensity;
        patch_feature_data['Hematoxylin_segment_std'] = segment_std_hematoxylin_intensity;        
        #patch_feature_json = json.dumps(patch_feature_data);
        patch_level_features.insert_one(patch_feature_data);             
    img.close();        
  exit();  
