...
if __name__ == '__main__':
  ...
  if step_num==3:
    ...
    picture_folder = os.path.join(my_home, 'seahawk2_patient_level_plot'); 
  ...
  if step_num==4:
    ...
    my_home="/home/bwang/patch_level";  
    picture_folder = os.path.join(my_home, 'seahawk2_patch_level_plot'); 
    if not os.path.exists(picture_folder):
      print '%s folder do not exist, then create it.' % picture_folder;
      os.makedirs(picture_folder);
  ...
  if step_num==5:
    ...
    my_home="/home/bwang/patch_level";
    csv_folder = os.path.join(my_home, 'seahawk2_patch_level_csv'); 
  ...
  if step_num==6:
    ...
    my_home="/home/bwang/patch_level";
    csv_folder = os.path.join(my_home, 'seahawk_patient_level_csv'); 
    if not os.path.exists(csv_folder):
      print '%s folder do not exist, then create it.' % csv_folder;
      os.makedirs(csv_folder);  
