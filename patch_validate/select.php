...
<body>
	...
	<section id="main" class="wrapper">
        ...
        <section class="post">
          <a href="radiomics_validate/image_list.php" class="image"><img src="images/camic.jpg" alt="" style="filter: grayscale(100%);"/></a>
          <div class="content">
                  <h3>Radiomics Features Validation</h3>
                  <p>Validate patch level Radiomics Features</p>
                  <a href="radiomics_validate/image_list.php" class="button">More</a>
          </div>
        </section>
