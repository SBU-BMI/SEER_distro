...
if __name__ == '__main__':
  ...
  collection_saved= db2.patch_level_features_add; 
  ...
  def findPrefixList(case_id):    
    ...
    prefix_file = os.path.join(code_base, input_file); 
  ...
  for item  in image_list:  
    ...
    for humanMarkup in humanMarkupList_tumor:
      validity=explain_validity(humanMarkup);
      geom_type=humanMarkup.geom_type;
      markup_area=humanMarkup.area;
      markup_bound=humanMarkup.bounds;
      print validity,geom_type,markup_area,markup_bound;
      #print humanMarkup
    #exit();
    '''
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor: 
      for index,tile_min_point in enumerate(unique_tile_min_point_list):  
        ...
        #if (tile_minx<>45056 or tile_miny<>47104):
        #  continue;
        ...
        for i in range(0,i_range):
          for j in range(0,j_range):
            ...
            #print  patchHumanMarkupRelation_tumor,  patchHumanMarkupRelation_nontumor;       
            ...
            '''
            target_patch_min_x=45568;
            target_patch_min_y=47616;            
            tile_max_x=tile_minx+2048;
            tile_max_y=tile_miny+2048;            
            print index,tile_min_point;            
            if (patchHumanMarkupRelation_tumor=="within"):
              if (target_patch_min_x >= tile_minx and target_patch_min_x <= tile_max_x):
                if (target_patch_min_y >= tile_miny and target_patch_min_y <= tile_max_y):   
            ...
            if patch_area1_seleted_percentage<1.0 and patch_area2_seleted_percentage <1.0:
              continue                           
            #if patch_min_x<>35328 or patch_min_y<>16896:
            #  continue             
