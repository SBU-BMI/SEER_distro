...
#login eagle cluster storage node "nfs004" to run this code
    
if __name__ == '__main__':
  if len(sys.argv)<0:
    print "usage:python composite_dataset_merge.py";
    exit();  
  ...
  #composite_dataset_folder="/data/shared/bwang/composite_dataset";
  #merged_composite_dataset_folder="/data/shared/bwang/composite_dataset_merged";
  
  # run this code in nfs007
  composite_dataset_folder="/data/shared/bwang/composite_results";
  merged_composite_dataset_folder="/data/shared/bwang/composite_results_merged";
  ...
  for case_id in os.listdir(composite_dataset_folder):
    print  case_id;          
