...
if __name__ == '__main__':
  if len(sys.argv)<1:
    print "usage:python generate_patch_level_tumor_based_features.py config.json";
    exit();  
      ...
      for j in  range (0,patch_y_num):         
        ...
        def getMatrixValueNew(poly_in):
          ...
          if (len(tmp_polygon) >0):   
            path = Path(tmp_polygon) # make a polygon
            ...
            if (special_case2=="within" and computer_polygon.within(patch_polygon)):#within/within
              ...
              if polygon_intersect.geom_type == 'MultiPolygon':                                 
                for p in polygon_intersect:
                  ...
                  getMatrixValueNew(polygon_intersect_points);                                                                    
