...
if __name__ == '__main__':
  if len(sys.argv)<1:
    print "usage:python generate_heatmap.py image_user_list";
    exit(); 
  ...
  def save2Meta(case_id,feature_name):     
    ...
    if(feature_name=="percent_nuclear_material"):      
      ...
      analysis_execution_id ="PL_Elongation_segment_mean_"+region_type;      
    elif (feature_name=="Elongation_segment_std"):     
      analysis_execution_id ="PL_Elongation_segment_std_"+region_type; 
  ...
  def removeAllHeatmaps_tumor(case_id):  
    ...
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Flatness_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Flatness_std_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Perimeter_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Perimeter_std_tumor"});                                                           
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Circularity_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Circularity_std_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_GradientMean_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_GradientMean_std_tumor"});      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_GradientMean_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_GradientMean_std_tumor"});      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_cytoIntensityMean_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_cytoIntensityMean_std_tumor"});      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_cytoIntensityMean_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_cytoIntensityMean_std_tumor"});                      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Elongation_segment_mean_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Elongation_segment_std_tumor"});       
    ...
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Flatness_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Flatness_std_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Perimeter_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Perimeter_std_tumor"});                                                           
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Circularity_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Circularity_std_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_GradientMean_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_GradientMean_std_tumor"});      
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_GradientMean_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_GradientMean_std_tumor"});      
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_cytoIntensityMean_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_cytoIntensityMean_std_tumor"});      
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_cytoIntensityMean_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_cytoIntensityMean_std_tumor"});     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Elongation_segment_mean_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Elongation_segment_std_tumor"});                                      
  ######################################################################
  ...
  def removeAllHeatmaps_non_tumor(case_id):  
    ...
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Flatness_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Flatness_std_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Perimeter_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Perimeter_std_non_tumor"});                                                           
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Circularity_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Circularity_std_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_GradientMean_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_GradientMean_std_non_tumor"});      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_GradientMean_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_GradientMean_std_non_tumor"});      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_cytoIntensityMean_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_r_cytoIntensityMean_std_non_tumor"});      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_cytoIntensityMean_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_b_cytoIntensityMean_std_non_tumor"});                      
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Elongation_segment_mean_non_tumor"});                     
    metadata.remove({"image.case_id":case_id,
                     "provenance.analysis_execution_id":"PL_Elongation_segment_std_non_tumor"});       
    ...
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Flatness_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Flatness_std_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Perimeter_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Perimeter_std_non_tumor"});                                                           
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Circularity_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Circularity_std_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_GradientMean_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_GradientMean_std_non_tumor"});      
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_GradientMean_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_GradientMean_std_non_tumor"});      
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_cytoIntensityMean_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_r_cytoIntensityMean_std_non_tumor"});      
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_cytoIntensityMean_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_b_cytoIntensityMean_std_non_tumor"});     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Elongation_segment_mean_non_tumor"});                     
    objects.remove({"provenance.image.case_id":case_id,
                     "provenance.analysis.execution_id":"PL_Elongation_segment_std_non_tumor"});                                      
  ######################################################################                   
  
  total_heatmap_count=0;
  yes_heatmap_count=0; 
  no_heatmap_count=0;                                                                  
  ...
  for item in image_list:  
    ...
    #metadata.find({"image.case_id":case_id,
    #               "provenance.analysis_execution_id":"PL_percent_nuclear_material_tumor"}); 
    
    '''                 
    heatmap_count=objects.find({"provenance.image.case_id":case_id,
                                "provenance.analysis.execution_id":"PL_percent_nuclear_material_tumor"}).count();
    if (heatmap_count>0):
      print "heat map for image " + str(case_id) +" has been created."; 
      yes_heatmap_count+=1;
      continue;
    else:
      print "heat map for image " + str(case_id) +" has NOT been created.";  
      print case_id+str(',')+user;
      no_heatmap_count+=1;                                     
    total_heatmap_count+=1
    '''
    
    #print  total_heatmap_count, yes_heatmap_count, no_heatmap_count;
    #continue;  
    ...
    if(record_count>0):
      ...
      save2Meta(case_id,"Elongation_segment_mean");
      save2Meta(case_id,"Elongation_segment_std");       
    else:
      continue;   
    ...
    min_Elongation_segment_mean=0.0;
    max_Elongation_segment_mean=0.0;
    min_Elongation_segment_std=0.0;
    max_Elongation_segment_std=0.0;    
    ...
    #------------
    for record in patch_level_dataset.find({"case_id":case_id,"user":user,"tumorFlag":region_type,"Elongation_segment_mean": { "$ne": "n/a" }},
                                          {"Elongation_segment_mean":1,"_id":0}).sort("Elongation_segment_mean",1).limit(1):
      min_Elongation_segment_mean = record["Elongation_segment_mean"];
      break;                                                          
    for record in patch_level_dataset.find({"case_id":case_id,"user":user,"tumorFlag":region_type,"Elongation_segment_mean": { "$ne": "n/a" }},
                                           {"Elongation_segment_mean":1,"_id":0}).sort("Elongation_segment_mean",-1).limit(1):
      max_Elongation_segment_mean = record["Elongation_segment_mean"];
      break; 
        
    for record in patch_level_dataset.find({"case_id":case_id,"user":user,"tumorFlag":region_type,"Elongation_segment_std": { "$ne": "n/a" }},
                                          {"Elongation_segment_std":1,"_id":0}).sort("Elongation_segment_std",1).limit(1):
      min_Elongation_segment_std = record["Elongation_segment_std"];
      break;                                                          
    for record in patch_level_dataset.find({"case_id":case_id,"user":user,"tumorFlag":region_type,"Elongation_segment_std": { "$ne": "n/a" }},
                                           {"Elongation_segment_std":1,"_id":0}).sort("Elongation_segment_std",-1).limit(1):
      max_Elongation_segment_std = record["Elongation_segment_std"];
      break;  
      
      
    print "min_r_cytoIntensityMean_segment_mean,max_r_cytoIntensityMean_segment_mean,min_r_cytoIntensityMean_segment_std,max_r_cytoIntensityMean_segment_std,min_b_cytoIntensityMean_segment_mean,max_b_cytoIntensityMean_segment_mean,    min_b_cytoIntensityMean_segment_std,max_b_cytoIntensityMean_segment_std,min_Elongation_segment_mean,max_Elongation_segment_mean,min_Elongation_segment_std,max_Elongation_segment_std";
    print min_r_cytoIntensityMean_segment_mean,max_r_cytoIntensityMean_segment_mean,min_r_cytoIntensityMean_segment_std,max_r_cytoIntensityMean_segment_std,min_b_cytoIntensityMean_segment_mean,max_b_cytoIntensityMean_segment_mean,    min_b_cytoIntensityMean_segment_std,max_b_cytoIntensityMean_segment_std,min_Elongation_segment_mean,max_Elongation_segment_mean,min_Elongation_segment_std,max_Elongation_segment_std;   
    ...
    for feature_record in patch_level_dataset.find({"case_id":case_id,
      ...
      if(percent_nuclear_material_normalized>1.0):
        percent_nuclear_material_normalized=1.0;
      elif (percent_nuclear_material_normalized<0.0):
        percent_nuclear_material_normalized=0.0;
        
      if(grayscale_patch_mean_normalized>1.0):
        grayscale_patch_mean_normalized=1.0;
      elif (grayscale_patch_mean_normalized<0.0):
        grayscale_patch_mean_normalized
                
      if(grayscale_patch_std_normalized>1.0):
        grayscale_patch_std_normalized=1.0;
      elif (grayscale_patch_std_normalized<0.0):
        grayscale_patch_std_normalized=0.0;        
          
      if(Hematoxylin_patch_mean_normalized>1.0):
        Hematoxylin_patch_mean_normalized=1.0;
      elif (Hematoxylin_patch_mean_normalized<0.0):
        Hematoxylin_patch_mean_normalized=0.0;
          
      if(Hematoxylin_patch_std_normalized>1.0):
        Hematoxylin_patch_std_normalized=1.0;
      elif (Hematoxylin_patch_std_normalized<0.0):        
        Hematoxylin_patch_std_normalized=0.0;
    ...
    for feature_record in patch_level_dataset.find({"case_id":case_id,
      ...
      if(grayscale_segment_mean_normalized>1.0):
        grayscale_segment_mean_normalized=1.0;
      elif (grayscale_segment_mean_normalized<0.0):
        grayscale_segment_mean_normalized=0.0;
                
      if(grayscale_segment_std_normalized>1.0):
        grayscale_segment_std_normalized=1.0;
      elif (grayscale_segment_std_normalized<0.0):
        grayscale_segment_std_normalized=0.0;
          
      if(Hematoxylin_segment_mean_normalized>1.0):
        Hematoxylin_segment_mean_normalized=1.0;
      elif (Hematoxylin_segment_mean_normalized<0.0):
        Hematoxylin_segment_mean_normalized=0.0;
          
      if(Hematoxylin_segment_std_normalized>1.0):
        Hematoxylin_segment_std_normalized=1.0;
      elif (Hematoxylin_segment_std_normalized<0.0):
        Hematoxylin_segment_std_normalized=0.0; 
      ...
      if(Flatness_segment_mean_normalized>1.0):
        Flatness_segment_mean_normalized=1.0;
      elif (Flatness_segment_mean_normalized<0.0):
        Flatness_segment_mean_normalized=0.0;
                 
      if(Flatness_segment_std_normalized>1.0):
        Flatness_segment_std_normalized=1.0;
      elif (Flatness_segment_std_normalized<0.0):
        Flatness_segment_std_normalized=0.0;
          
      if(Perimeter_segment_mean_normalized>1.0):
        Perimeter_segment_mean_normalized=1.0;
      elif (Perimeter_segment_mean_normalized<0.0):
        Perimeter_segment_mean_normalized=0.0;
         
      if(Perimeter_segment_std_normalized>1.0):
        Perimeter_segment_std_normalized=1.0;
      elif (Perimeter_segment_std_normalized<0.0):        
        Perimeter_segment_std_normalized=0.0;
      ...
      if(Circularity_segment_mean_normalized>1.0):
        Circularity_segment_mean_normalized=1.0
      elif (Circularity_segment_mean_normalized<0.0):
        Circularity_segment_mean_normalized=0.0
                 
      if(Circularity_segment_std_normalized>1.0):
        Circularity_segment_std_normalized=1.0
      elif (Circularity_segment_std_normalized<0.0):
        Circularity_segment_std_normalized=0.0
          
      if(r_GradientMean_segment_mean_normalized>1.0):
        r_GradientMean_segment_mean_normalized=1.0;
      elif (r_GradientMean_segment_mean_normalized<0.0):
        r_GradientMean_segment_mean_normalized=0.0;
         
      if(r_GradientMean_segment_std_normalized>1.0):
        r_GradientMean_segment_std_normalized=1.0;
      elif (r_GradientMean_segment_std_normalized<0.0):
        r_GradientMean_segment_std_normalized=0.0; 
      ...
      if(b_GradientMean_segment_mean_normalized>1.0):
        b_GradientMean_segment_mean_normalized=1.0;
      elif (b_GradientMean_segment_mean_normalized<0.0):
        b_GradientMean_segment_mean_normalized=0.0;
                
      if(b_GradientMean_segment_std_normalized>1.0):
        b_GradientMean_segment_std_normalized=1.0;
      elif (b_GradientMean_segment_std_normalized<0.0):
        b_GradientMean_segment_std_normalized=0.0;
       
      if(r_cytoIntensityMean_segment_mean_normalized>1.0):
        r_cytoIntensityMean_segment_mean_normalized=1.0;
      elif (r_cytoIntensityMean_segment_mean_normalized<0.0):
        r_cytoIntensityMean_segment_mean_normalized=0.0;
         
      if(r_cytoIntensityMean_segment_std_normalized>1.0):
        r_cytoIntensityMean_segment_std_normalized=1.0;
      elif (r_cytoIntensityMean_segment_std_normalized<0.0):
        r_cytoIntensityMean_segment_std_normalized=0.0;         
      ...
      if(b_cytoIntensityMean_segment_mean_normalized>1.0):
        b_cytoIntensityMean_segment_mean_normalized=1.0;
      elif (b_cytoIntensityMean_segment_mean_normalized<0.0):
        b_cytoIntensityMean_segment_mean_normalized=0.0;
               
      if(b_cytoIntensityMean_segment_std_normalized>1.0): 
        b_cytoIntensityMean_segment_std_normalized=1.0;
      elif (b_cytoIntensityMean_segment_std_normalized<0.0):
        b_cytoIntensityMean_segment_std_normalized=0.0;
      ...
      #----------------------------------
      Elongation_segment_mean=feature_record["Elongation_segment_mean"];             
      Elongation_segment_mean_normalized=float(Elongation_segment_mean - min_Elongation_segment_mean)/float(max_Elongation_segment_mean-min_Elongation_segment_mean);  
                          
      Elongation_segment_std=feature_record["Elongation_segment_std"];
      Elongation_segment_std_normalized=float(Elongation_segment_std - min_Elongation_segment_std)/float(max_Elongation_segment_std - min_Elongation_segment_std);             
       
      print index2,Elongation_segment_mean_normalized,Elongation_segment_std_normalized;
      if(Elongation_segment_mean_normalized>1.0):
        Elongation_segment_mean_normalized=1.0;
      elif (Elongation_segment_mean_normalized<0.0):
        Elongation_segment_mean_normalized=0.0;
               
      if(Elongation_segment_std_normalized>1.0):
        Elongation_segment_std_normalized=1.0;
      elif (Elongation_segment_std_normalized<0.0):
        Elongation_segment_std_normalized=0.0;
        
      save2Objects(case_id,"Elongation_segment_mean",patch_size,tmp_patch_polygon,Elongation_segment_mean_normalized); 
      save2Objects(case_id,"Elongation_segment_std",patch_size,tmp_patch_polygon,Elongation_segment_std_normalized);         
