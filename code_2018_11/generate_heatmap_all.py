...
if __name__ == '__main__':
  if len(sys.argv)<1:
    print "usage:python generate_heatmap_all.py config.json";
    exit(); 
  ...
  def save2Meta(case_id,feature_name):     
    ...
    if(feature_name=="percent_nuclear_material"):
      title="PL_percent_nuclear_material_all";
      analysis_execution_id ="PL_percent_nuclear_material_all";        
    elif (feature_name=="grayscale_patch_mean"):
      title="PL_grayscale_patch_mean_all";
      analysis_execution_id ="PL_grayscale_patch_mean_all";    
    elif (feature_name=="grayscale_patch_std"):
      title="PL_grayscale_patch_std_all";
      analysis_execution_id ="PL_grayscale_patch_std_all";
    elif (feature_name=="Hematoxylin_patch_mean"):
      title="PL_Hematoxylin_patch_mean_all";
      analysis_execution_id ="PL_Hematoxylin_patch_mean_all";    
    elif (feature_name=="Hematoxylin_patch_std"):
      title="PL_Hematoxylin_patch_std_all";
      analysis_execution_id ="PL_Hematoxylin_patch_std_all";      
    
    elif (feature_name=="grayscale_segment_mean"):
      title="PL_grayscale_segment_mean_all";
      analysis_execution_id ="PL_grayscale_segment_mean_all";    
    elif (feature_name=="grayscale_segment_std"):
      title="PL_grayscale_segment_std_all";
      analysis_execution_id ="PL_grayscale_segment_std_all";
    elif (feature_name=="Hematoxylin_segment_mean"):
      title="PL_Hematoxylin_segment_mean_all";
      analysis_execution_id ="PL_Hematoxylin_segment_mean_all";    
    elif (feature_name=="Hematoxylin_segment_std"):
      title="PL_Hematoxylin_segment_std_all";
      analysis_execution_id ="PL_Hematoxylin_segment_std_all";  
  ...
  for item in image_list:  
    ...
    index=0;
    for feature_record in patch_level_features.find({"case_id":case_id,
                                                     "user":user,
                                                     "percent_nuclear_material": { "$gt": 0.0 }}):       
    ...
    for feature_record in patch_level_features.find({"case_id":case_id,
      ...
      #print  percent_nuclear_material;
      x1=float(patch_min_x_pixel)/float(image_width);
      y1=float(patch_min_y_pixel)/float(image_height);
      x2=float(patch_min_x_pixel+patch_size)/float(image_width);
      y2=float(patch_min_y_pixel+patch_size)/float(image_height);
