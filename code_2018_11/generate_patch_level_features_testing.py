...
if __name__ == '__main__':
  if len(sys.argv)<1:
    print "usage:python generate_patch_level_features_testing.py case_id";
    exit();  
  ...
  feature_name_list=[]; 
  feature_name_list.append("Flatness");  
  feature_name_list.append("Perimeter");  
  feature_name_list.append("Circularity");  
  feature_name_list.append("r_GradientMean");  
  feature_name_list.append("b_GradientMean");  
  feature_name_list.append("r_cytoIntensityMean");  
  feature_name_list.append("b_cytoIntensityMean");
  ...
  for case_id in image_list:  
    ...
    print " ==== image_width,image_height again === ";
    print image_width,image_height 
          ...
          for j in range(0,j_range):
            ...
            for tile_item in tile_item_array:
              ...
              if(is_within or is_intersects):
                ...
                validity=explain_validity(computer_polygon);            
