...
if __name__ == '__main__':
  if len(sys.argv)<1:
    print "usage:python generate_heatmap.py config_175.json";
    exit(); 
  ...
  patch_level_dataset = db2.patch_level_features_tmp2;  
  ...
  for item in image_list:  
    ...
    for feature_record in patch_level_dataset.find({"case_id":case_id,
      ...
      print grayscale_patch_mean,grayscale_patch_std,Hematoxylin_patch_mean,Hematoxylin_patch_std;
    ...
    print " -- min_grayscale_patch_mean, max_grayscale_patch_mean --";
    print min_grayscale_patch_mean, max_grayscale_patch_mean;
